  ...
  return (
    <div className="Calories-navbar">
      <div className="leftCalories-navbar">
        <div>
          <i className="bx bx-menu-alt-left" onClick={handleMenu} style={{display:isactive && 'none'}}></i>
        </div>
      ...
      <ul className="parentULnavbar">
            <li>
              ...
              >
                <img
                  src={`http://localhost:8000/api/profile-image/?id=${isAuth}&${Date.now()}`}
                ...
                <ul className="ULprofileHome">
                  ...
                  <li>
                    <Link to='/CaloriesCalculator/change-goal'>
                      <button><i class='bx bxs-analyse'></i> Change goal</button>
                    </Link>
                  </li>
                  <li>
